...
const Updatepassword = () => {
    ...
    return (
        ...
        <div className="retour">
             <a className="bn" href="../dashboard" role="button">Retour</a>
        </div>
            <div id="body2">
                <div id="body3">
                            ...
                            <Form onSubmit={handleSubmit(onSubmit)} className="" >
                                <Form.Group className="mb-3" controlId="formBasicPassword">
                                    ...
                                    <div className="input-text">
                                        <Form.Label>Actuel mot de passe<span id="etoile">*</span></Form.Label>
                                        <Form.Control  type={password1} className={` ${password_actuel ? "warning" : ""} ${type ? "type_password" : ""}`}
                                    ...
                                    <div id='msgerror'>
                                        {errors.password_actuel?.type === "required" && "Ce champs est requis"}
                                ...
                                <Form.Group className="mb-3" controlId="formBasicPassword">
                                    ...
                                    <div className="input-text">
                                        <Form.Label>Nouveau mot de passe<span id="etoile">*</span></Form.Label>
                                        <Form.Control id="compa"  type={password2} className={` ${password_news ? "warning" : ""} ${type ? "type_password" : ""}`}
                                            placeholder="veillez saisir votre mot de passe"
                                            {...register("password2", {
                                                required: true,
                                                minLength: 5,
                                        ...
                                        />
                                        <i className="bi bi-eye"></i>
                                        <i onClick={()=>{Eye_news()}} className={`bi ${eye2 ? "bi bi-eye-slash" : "bi-eye"}`}></i>
                                    </div>

                                    <div id='msgerror'>
                                        {errors.password2?.type === "required" && "Ce champs est requis"}
                                ...
                                <Form.Group className="mb-3" controlId="formBasicPassword">
                                    ...
                                    <div className="input-text">
                                        <Form.Label>Confirmation mot de passe<span id="etoile">*</span></Form.Label>
                                        <Form.Control id="new"  onKeyUp={() =>{must()}}  type={password3} className={` ${password_confirm ? "warning" : ""} ${type ? "type_password" : ""}`}
                                            placeholder="veillez saisir votre mot de passe"
                                            {...register("password3", {
                                                required: true,
                                        ...
                                        />
                                        <i className="bi bi-eye"></i>
                                        <i onClick={()=>{Eye_confirm()}} className={`bi ${eye3 ? "bi bi-eye-slash" : "bi-eye"}`}></i>
                                    </div>
                                    <p className={`text-danger ${musted ? "afficher" : "cacher"}`} >les valeurs ne correspondent pas</p>
                                    <div id='msgerror'>
                                        {errors.password3?.type === "required" && "Ce champs est requis"}
